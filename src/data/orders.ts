...
export const orders: Order[] = [
  {
    id: "ord_demo_approve", customerId: "cus_001", status: "DELIVERED", currency: "USD",
  ...
  {
    id: "ord_demo_final_sale", customerId: "cus_002", status: "DELIVERED", currency: "USD",
  ...
  {
    id: "ord_demo_expired", customerId: "cus_003", status: "DELIVERED", currency: "USD",
  ...
  {
    id: "ord_demo_used", customerId: "cus_004", status: "DELIVERED", currency: "USD",
  ...
  {
    id: "ord_demo_high_risk", customerId: "cus_006", status: "DELIVERED", currency: "USD",
  ...
  {
    id: "ord_demo_partial", customerId: "cus_009", status: "DELIVERED", currency: "USD",
